$(function() {
  $hs.init();
  $hs.modules.BprimeziWeb.init();
  $hs.modules.BPrime.init();
  $hs.modules.InctimeUtils.init();
  $hs.modules.InctimeHtmlPrime.init();
  ...
  $("input[type=submit]").click(function(e) {
    e.preventDefault();
    var input_change = $hs.modules.BprimeziWeb.hs_parsezurequest.hscall(query());
    var state_change = $hs.modules.BPrime.hs_appzzustatezuincrementalised.hscall(input_change);
    var ui_change = $hs.modules.BPrime.hs_pagezzuviewzuincrementalised.hscall(state_change);
